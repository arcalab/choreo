...
import mat.frontend.widgets.{Box, CodeBox, DomNode, OutputArea, VisualiseMermaid}
import choreo.frontend.ChoreoAC
...
object Main {
  ...
  //      case v: mat.view.Mermaid => new VisualiseMermaid(()=>v.code,config.name,out)
  //      case _: mat.view.Text => sys.error("Text visualiser not supported")
  //      case _: mat.view.Html => sys.error("HTML visualiser not supported")
  //    }
